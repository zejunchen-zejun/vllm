...
def split_decodes_prefills_and_extends(
    ...
    if max_query_len <= decode_threshold:
        print(
            "[zejun] split_decodes_prefills_and_extends, only decode, return",
            flush=True,
        )
        return num_reqs, 0, 0, num_tokens, 0, 0

    print(
        "[zejun] split_decodes_prefills_and_extends, query_start_loc = ",
        query_start_loc,
        flush=True,
    )
    ...
    print(
        "[zejun] split_decodes_prefills_and_extends, query_lens = ",
        query_lens,
        flush=True,
    )
    print(
        "[zejun] split_decodes_prefills_and_extends, seq_lens(KV) = ",
        seq_lens,
        flush=True,
    )
    print(
        "[zejun] split_decodes_prefills_and_extends, is_prefill_or_extend = ",
        is_prefill_or_extend,
        flush=True,
    )
    print(
        "[zejun] split_decodes_prefills_and_extends, is_prefill = ",
        is_prefill,
        flush=True,
    )
    print(
        "[zejun] split_decodes_prefills_and_extends, first_extend = ",
        first_extend,
        flush=True,
    )
    print(
        "[zejun] split_decodes_prefills_and_extends, first_prefill = ",
        first_prefill,
        flush=True,
    )
    ...
    print(
        "[zejun] split_decodes_prefills_and_extends, num_prefills_or_extends = ",
        num_prefills_or_extends,
        flush=True,
    )
    print(
        "[zejun] split_decodes_prefills_and_extends, num_prefill_or_extend_tokens = ",
        num_prefill_or_extend_tokens,
        flush=True,
    )
    print(
        "[zejun] split_decodes_prefills_and_extends, torch.any(is_prefill) = ",
        torch.any(is_prefill),
        flush=True,
    )
    ...
    print(
        "[zejun] split_decodes_prefills_and_extends, num_extends = ",
        num_extends,
        flush=True,
    )
    print(
        "[zejun] split_decodes_prefills_and_extends, num_prefills = ",
        num_prefills,
        flush=True,
    )
    print(
        "[zejun] split_decodes_prefills_and_extends, num_prefill_tokens = ",
        num_prefill_tokens,
        flush=True,
    )
    print(
        "[zejun] split_decodes_prefills_and_extends, num_extend_tokens = ",
        num_extend_tokens,
        flush=True,
    )
